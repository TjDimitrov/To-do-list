...
# Button widget
entry_button = Button(window, text="Add new task", width=50, command=enter_task)
entry_button.pack(pady=3)

delete_button = Button(window, text="Delete selected task", width=50, command=delete_task)
delete_button.pack(pady=3)

mark_button = Button(window, text="Mark as completed ", width=50, command=mark_as_completed)
